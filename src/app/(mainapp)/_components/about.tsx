      ...
      <div className="flex flex-col items-center justify-center sm:flex-row gap-12 ">
        ...
        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeOut" }} viewport={{ once: true }} className="flex justify-center md:justify-end">
          <div className="relative w-60 h-80 md:w-[300px] md:h-[420px] rounded-2xl overflow-hidden border border-gray-800/60 shadow-[0_0_30px_rgba(255,255,255,0.05)] bg-linear-to-br from-indigo-950/40 via-purple-900/20 to-teal-900/30">
            <Image src="/profile.jpg" alt="Wahyu Kurniawan" fill className="object-cover opacity-90" />
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 leading-relaxed text-base md:text-lg mb-4">
            I&apos;m <span className="text-gray-100 font-semibold">Wahyu Kurniawan</span> — Lorem ipsum dolor sit amet consectetur adipisicing elit. Id earum, repudiandae aut quam possimus repellendus ab qui, vitae corrupti quo voluptas.
            Laborum aspernatur praesentium laudantium, numquam eligendi quisquam fugiat corporis!
          </p>

          <p className="text-gray-400 leading-relaxed text-base md:text-lg mb-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla autem cumque maxime reiciendis iusto amet aliquid. Numquam voluptate et placeat illo culpa? Ullam.
            <span className="text-indigo-400 font-medium">React</span>, <span className="text-pink-400 font-medium">Next.js</span>, and <span className="text-teal-400 font-medium">Tailwind CSS</span> Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Placeat, veniam.
          </p>
